...
export const ChatBox = ({isVisible}) => {
  ...
  return (
    isVisible && (
      <div className="z-z9999 fixed bottom-20 right-1 sm:right-5 lg:w-[331px] lg:h-[476px] md:w-[280px] md:h-[400px] h-[300px] sm:w-[240px] bg-color1 border border-gray-300 rounded-lg shadow-lg flex flex-col justify-between">
